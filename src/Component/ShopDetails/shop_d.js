            ...
            <div className="row">
                <div className="col-lg-3 col-md-4 col-sm-6">
                    <div className="product__item">
                        ...
                        <a href="./index.html"><img src="assets/img/product/product-1.jpg" alt=""/> </a>
                ...
                <div className="col-lg-3 col-md-4 col-sm-6">
                    <div className="product__item">
                        <div className="product__item__pic set-bg" data-setbg="">
                        <a href="./index.html"><img src="assets/img/product/product-2.jpg" alt=""/> </a>
                            <ul className="product__item__pic__hover">
                                <li><a href="#"><i className="fa fa-heart"></i></a></li>
                                <li><a href="#"><i className="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i className="fa fa-shopping-cart"></i></a></li>
                ...
                <div className="col-lg-3 col-md-4 col-sm-6">
                    <div className="product__item">
                        <div className="product__item__pic set-bg" data-setbg="">
                        <a href="./index.html"><img src="assets/img/product/product-3.jpg" alt=""/> </a>
                            <ul className="product__item__pic__hover">
                                <li><a href="#"><i className="fa fa-heart"></i></a></li>
                                <li><a href="#"><i className="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i className="fa fa-shopping-cart"></i></a></li>
                ...
                <div className="col-lg-3 col-md-4 col-sm-6">
                    <div className="product__item">
                        ...
                        <a href="./index.html"><img src="assets/img/product/product-7.jpg" alt=""/> </a>
                            <ul className="product__item__pic__hover">
                                <li><a href="#"><i className="fa fa-heart"></i></a></li>
                                <li><a href="#"><i className="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i className="fa fa-shopping-cart"></i></a></li>
